...
class CustomerCompleteServiceDetailsView
    extends GetView<CustomerCompleteServiceDetailsController> {
  const CustomerCompleteServiceDetailsView({super.key});
  @override
  ...
  Widget buildLabelValueRow(
    ...
    return Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: labelStyle ?? AppTextStyles.medium16),
        Text(value, style: valueStyle ?? AppTextStyles.regular12),
      ],
    );
  }
}
