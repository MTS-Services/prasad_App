            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Drone UIN UK', style: AppTextStyles.regular16),
                  buildContainer('IND-DRN-UK-5842'),
                  Text('License Number', style: AppTextStyles.regular16),
                  buildContainer('DGCA-IND-DRONE-784512'),
                  Text('License Issue Date', style: AppTextStyles.regular16),
                  buildContainer('2023-02-10'),
                  Text('License Expiry Date', style: AppTextStyles.regular16),
                  buildContainer('2028-02-09'),
                  Text('Service Capabilities', style: AppTextStyles.regular16),
                  ...
                  Text('Flight Hours', style: AppTextStyles.regular16),
                  buildContainer('156 Hours'),
                  Text('Last Maintenance_Date', style: AppTextStyles.regular16),
                  buildContainer('2025-07-15'),
                  Text('Insurance Status', style: AppTextStyles.regular16),
                  buildContainer('Active (Valid till 2026-07-14)'),
                  Text('Operational Status', style: AppTextStyles.regular16),
                  buildContainer('Operational'),
                  Text('Battery type', style: AppTextStyles.regular16),
                  buildContainer('LiPo 4S'),
                  Text('Battery Cycles', style: AppTextStyles.regular16),
                  buildContainer('87'),
                  Text(
                  ...
                  Text('Drone Condition', style: AppTextStyles.regular16),
