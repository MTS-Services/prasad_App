...
class AppColors{
  ...
  static const Color primaryColor = Color(0xff28A844);
  static const Color borderColorBlue = Color(0xff002244);
  static const Color blackColor = Color(0xff000000);
  static const Color hintColor = Color(0xff7C7C7C);
  static const Color lightGeryColor = Color(0xFFF3F3F3);
  static const Color borderColorGrey = Color(0xffD9D9D9);
  static const Color bottomNaviTextColor = Color(0xff989898);
